...
public:
    ...
    // W przypadku naszej klasy parametr ten ptrazuje na null
...
QPushButton *liniaButton;
    ...
    bool klikniete = false , isElipsa = false, isKolo=false, isLinia=false, isWypelnienie=false;
    // Deklaracje funkcji
    void czysc();
...
void floodFill(int x, int y, QImage *image);
    struct Wspolrzedna {
        int x;
        int y;
    };
QQueue<Wspolrzedna> WspolrzednasQueue;
